...
{
    [CreateAssetMenu(menuName = "Skills/Hero/FrostFieldSkillSettings", fileName = "FrostFieldSkillSettings")]
    public class FrostFieldSkillSettings : ScriptableObject, IDamageSettings
    {
        ...
        private FrostFieldSkillBehaviour _skill;
        ...
        public void LevelUp(GameObject gameObject)
        {
            ...
            _skill = _gameObject.GetComponent<FrostFieldSkillBehaviour>();

            if (_skill == null)
            {
                _skill = gameObject.AddComponent<FrostFieldSkillBehaviour>();
                UpdateSkill();
                ApplyBaseSettings();
            }
            else
        ...
        private void ApplyBaseSettings()
        {
            ...
            skillSystem.GetObjectSelectedSkil("FrostField").GetComponent<FrostFieldController>().Init(_skill);
