...
{
    [CreateAssetMenu(menuName = "Skills/Hero/EarthquakeSkillSettings", fileName = "EarthquakeSkillSettings")]
    public class EarthquakeSkillSettings : ScriptableObject, IDamageSettings
    {
        ...
        private EarthquakeSkillBehaviour _skill;
        ...
        public void LevelUp(GameObject gameObject)
        {
            ...
            _skill = _gameObject.GetComponent<EarthquakeSkillBehaviour>();

            if (_skill == null)
            {
                _skill = gameObject.AddComponent<EarthquakeSkillBehaviour>();
                UpdateSkill();
                ApplyBaseSettings();
            }
            else
        ...
        private void ApplyBaseSettings()
        {
            ...
            skillSystem.GetObjectSelectedSkil("Earthquake").GetComponent<EarthquakeController>().Init(_skill);
