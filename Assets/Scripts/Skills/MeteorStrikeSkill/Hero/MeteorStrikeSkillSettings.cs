...
{
    [CreateAssetMenu(menuName = "Skills/Hero/MeteorStrikeSkillSettings", fileName = "MeteorStrikeSkillSettings")]
    public class MeteorStrikeSkillSettings : ScriptableObject, IDamageSettings

    {
        ...
        private MeteorStrikeSkillBehavior _skill;
        ...
        public void LevelUp(GameObject gameObject)
        {
            ...
            _skill = _gameObject.GetComponent<MeteorStrikeSkillBehavior>();

            if (_skill == null)
            {
                _skill = gameObject.AddComponent<MeteorStrikeSkillBehavior>();
                UpdateSkill();
                ApplyBaseSettings();
            }
            else
        ...
        private void ApplyBaseSettings()
        {
            ...
            skillSystem.GetObjectSelectedSkil("MeteorStrike").GetComponent<MeteorStrikeController>().Init(_skill);
