...
{
    [CreateAssetMenu(menuName = "Skills/Hero/PoisonSkillSettings", fileName = "PoisonSkillSettings")]
    public class PoisonSkillSettings : ScriptableObject, IDamageSettings
    {
        ...
        private PoisonSkillBehaviour _skill;
        ...
        public void LevelUp(GameObject gameObject)
        {
            ...
            _skill = _gameObject.GetComponent<PoisonSkillBehaviour>();

            if (_skill == null)
            {
                _skill = gameObject.AddComponent<PoisonSkillBehaviour>();
                UpdateSkill();
                ApplyBaseSettings();
            }
            else
        ...
        private void ApplyBaseSettings()
        {
            ...
            skillSystem.GetObjectSelectedSkil("PoisonSkill").GetComponent<PoisonController>().Init(_skill);
